...
public class InformationTemplete
{
	 ...
	 */
	public static final int MAX_INTRODUCTION_CHARACTER_SIZE = 4;
	
	/**
	 * 캐릭터 및 동화 소개글의 백그라운드 색 및 썸네일 배경 색 의 백그라운드
	 */
	public static final String COLOR_THUMBNAIL_BACKGROUND 		= "#ffff78";
	public static final String COLOR_INTRODUCTION_BACKGROUND 	= "#e84653";
	public static final String COLOR_DEVICE_CODE_TEXT			= "#ccca58";
	public static final String COLOR_INTRODUCTION_TEXT			= "#ffffff";
	
	/**
	 * 앱 이름
	 */
	public static final String APP_NAME = "MagicMarker";
	/**
	 * 어플리케이션의 패키지명 : 반드시 변경
	 */
	public static final String PACKAGE_NAME 				= "com.littlefox.storybook.magicmarker";
	
	/**
	 * 영상이 저장될 위치 : 반드시 변경
	 */
	public static final String MP4_FILE_PATH 				= Environment.getExternalStorageDirectory() + File.separator + "Littlefox"+ File.separator+"Storybook"+File.separator+"MagicMarker"+File.separator;
	
	/**
	 * 로그 파일 저장 명  : 반드시 변경
	 */
	public static final String LOG_FILE						= "story_book_magic_marker.txt";
	 ...
	 */
	public static final String APP_LINK = "https://play.google.com/store/apps/details?id=com.littlefox.storybook.magicmarker";
	...
	public static final String PRICE_ALL_ITEM = "$ 6.99";
	
	/**
	 * API 서버 통신을 위한 Header 값
	 */
	public static final String HTTP_HEADER_APP_NAME = "LF_App_Storybook_MagicMarker";
	
	/**
	 * 구글 애널리틱스를 등록했던 앱의 ID
	 */
	public static final String GOOGLE_ANALYTICS_PROPERTY_ID = "UA-37277849-28";
	
	/**
	 * 하나 아이템의 SKU
	 */
	public static final String ONE_PAY_ITEM_SKU = "lf_sb_mm_1";
	
	/**
	 * 전체 아이템의 SKU
	 */
	public static final String ALL_PAY_ITEM_SKU = "lf_sb_mm_all";
	
	/**
	 * 결제 관련 IN APP BILLING KEY : 앱을 베타테스트로 Publish 한 후에 해당 어플리케이션 정보에서 Services & APIs 항목의  Licensing & IN-APP Billing 의 키를 복사하여 바꾼다.
	 */
	public static final String IN_APP_BILLING_KEY = "";
	 ...
	 * 서버 어플리케이션의 서버키 
	 */
	public static final String SERVER_KEY = "AIzaSyCJV4Sa2m0C6154u7FxlImIxd6bnjCU2kE";
	
	/**
	 * Google API Console 에 등록한 Project ID
	 */
	public static final String SENDER_ID = "692528379405";
	...
	public static final int MAX_AVAILABLE_FOR_PULCHASE_STORY_SIZE = 73;
